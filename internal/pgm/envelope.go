...
func (e *Envelope) GetVelocityToLevel() int { return int(e.buf.GetByte(e.base + EnvVelocityToLevel.Offset)) }
func (e *Envelope) SetVelocityToLevel(v int) { e.buf.SetByte(e.base+EnvVelocityToLevel.Offset, byte(v)) }
