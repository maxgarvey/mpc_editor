...
func (f *Filter1) GetVelocityToFreq() int {
	return int(f.buf.GetByte(f.base + Filter1VelocityToFreq.Offset))
}
func (f *Filter1) SetVelocityToFreq(v int) {
	f.buf.SetByte(f.base+Filter1VelocityToFreq.Offset, byte(v))
}
...
func (f *Filter2) GetVelocityToFreq() int {
	return int(f.buf.GetByte(f.base + Filter2VelocityToFreq.Offset))
}
func (f *Filter2) SetVelocityToFreq(v int) {
	f.buf.SetByte(f.base+Filter2VelocityToFreq.Offset, byte(v))
}
